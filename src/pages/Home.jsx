...
export default function Home() {
  ...
  return (
    <div style={{ background: "var(--bg)" }}>
      ...
      {/* ===== Login (on-page section, id="login") ===== */}
      <section id="login" style={{ background: "var(--sage)", padding: "90px 24px 100px", scrollMarginTop: 150 }}>
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          ...
          <Reveal delay={100}>
            <h2 className="font-display" style={{ fontSize: "clamp(28px,5vw,44px)", color: "var(--forest-dark)", fontWeight: 500, marginBottom: 40 }}>
              Who's logging in?
            </h2>
          </Reveal>
